    ...
    useEffect(() => {
        ...
        if (params.id) {
            ...
            const channel = supabase
                .channel(`product-detail-${params.id}`)
                .on('postgres_changes', {
        ...
        <div className="min-h-screen bg-[#0f0f23]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    {/* Product Image */}
                    <div className="bg-gradient-to-br from-[#1e2a4a]/80 to-[#16213e]/80 rounded-2xl border border-white/10 flex items-center justify-center p-8 min-h-[350px] overflow-hidden">
                    ...
                    <div>
                        ...
                        <div className="mb-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {specs.map((spec, i) => (
                                    <span key={i} className="text-sm text-gray-300 bg-white/5 px-3 py-1.5 rounded-lg border border-white/5">
                                        {spec}
                                    </span>
                                ))}
                            </div>
                        ...
                        <div className="flex flex-col gap-3">
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    disabled={product.stock_status === 'out_of_stock'}
                                    className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white py-3.5 rounded-xl font-bold text-lg shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/40 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Buy Now
                                </button>
                            </div>
